...
const userPosts = [
  {
    ...
    //descrição do post
    description: 'A Framework Digital, irá iniciar o seu sexto programa de estágio...',
    //texto do post
  ...
  },
  {
    ...
    description: 'Em Segurança da Informação, as vagas são destinadas às áreas de Security Operations Center (SOC), Administração de Dispositivos de Segurança (ADS)...',
  ...
  },
  {
    ...
    description: 'A Programação Funcional é uma orientação focada na programação declarativa. Conhecendo mais a programação funcional a partir...',
